...
<script>
	...
	$(function () {
        ...
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Simulação Reajuste de 5% MPU e Judiciário</title>
    </head>
    <body onload="mostraContribuicaoFunpresp();mostraCampos();orgaoAltera();">
      <?php
      include '../menu.php';
      ?>
        <h1>Simulação Reajuste de 5% do MPU e Judiciário</h1>
        <p>Planilha para cálculo personalizado de como ficarão os salários dos servidores do MPU e Judiciário
 em caso de reajuste mediante revisão geral de 5%. Neste caso, entende-se que a revisão geral ocorreria por meio de reajuste de 5% no vencimento básico, funções, cargos em comissão e incorporações (VPI's).
         <div>
...
<option value="0.085"> 8,5%</option>
				...
				<option value="1"> 1</option>
                    ...
                    <tr>
                    	<td>GAJ/GAMPU (para fins de simulação alternativa)</td>
                    	<td><input type="number" id="gajAlternativa" value="160" name="gajAlternativa" />%</td>
                    </tr>
                    <tr>
                        <td>GAS/GAE
                            <br/>Insalubridade<br />
		...
		<hr width="50%">
	<p>Atualizado em 14/04/2022. <a href="sobre.php">Sobre o Sistema</a></p>
