    ...
    <body onload="mostraContribuicaoFunpresp();orgaoAltera();">
     ...
     include '../menu.php';
      ...
      <div class="container-fluid">
        <h1>Simulação de Revisão Geral de 5% para MPU e Judiciário Federal.</h1>
        <p>Esta simulação visa demonstrar a nova remuneração dos servidores do Ministério Público da União (MPU) e Poder Judiciário da União (PJU), ante as notícias de que o reajuste a ser dado em 2022 será na modalidade de revisão geral, no percentual de 5%. Para cálculo da remuneração atual, no menu acima, escolha a opção "PCS's-MPU e PJU", e selecione "cálculo vigente".</p>
         <div>

            <form action="calcula5.php" method="post" class="row ">
