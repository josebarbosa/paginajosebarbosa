...
function calculaNovaPrevidencia($vencimento, $ano){
    ...
    function listaReferencias(){
        ...
        $gajAlternativa = $_POST['gajAlternativa']/100;
            ...
            if($anuenio){
                ...
                */
                if($vpni>0){
                        ...
                        echo "<tr><td>VPNI: </td><td align='right'>".formataNumeroReal($vpniAjustado)." </td></tr>";
                        $bruto += $vpniAjustado;
...
echo "<tr><td><font size='2'>Rendimentos Tributáveis</b>: </td><td align='right'><b>".formataNumeroReal($rendimentosTributaveis)."</font> </td></tr>";
 ...
 if($orgao == 1)echo "<tr><td><font size='2'>Teto do Auxílio Saúde (8%)</b>: </td><td align='right'><b>".formataNumeroReal($valorAuxSaude)."</font> </td></tr>";
        ...
        /**
        SEGUNDA TABELA - ALTERNATIVA GAJ
        ==================================================
        ...
        **/
        ...
        $query = "select vencimento_basico as vb from vencimentos where
                ...
                echo "
                <hr/>
                <p>Simulação alternativa. Considera que o impacto sobre a folha seria transferido para a GAJ/GAMPU. Estima-se que possa ser corrigido passando dos atuais 140% para algo entre 155% a 165%. </p>
                <table>
                <tr><td>Rubrica</td><td>Valor (R$)</td></tr>
                <tr><td>Vencimento Básico (".$nivel."): </td><td align='right'>".formataNumeroReal($vencimento)." </td></tr>";
                $bruto = $vencimento;
                ...
                */
                ...
                $gajIndice = $gajAlternativa;
                $gaj = round(($vencimento * $gajAlternativa),2);
                if($orgao == 1) $auxSaude += $gaj;
                if($orgao==1) echo "<tr><td>GAMPU: </td><td align='right'>".formataNumeroReal($gaj)." </td></tr>";
                else echo "<tr><td>Gratificação Judiciária: </td><td align='right'>".formataNumeroReal($gaj)." </td></tr>";
                $bruto += $gaj;
