...
<script async="true" type="text/javascript" src="//venom.spider.ad?id=61171"></script>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <script>
...
$gasIndice = $_POST['gas'];
                        ...
                        while($row = mysqli_fetch_array($resultado, MYSQLI_ASSOC)){
                                 ...
                                 */
                                  ...
                                  /*
                                 * Busca o valor relativo ao adicional de treinamento
                                 */
                                 if($at && $orgao==1){
                                 ...
                                 */
                                 if ($anoReferencia<=2017) $auxilioAlimentacao = 884.00; else $auxilioAlimentacao = 910.08;
                                 ...
                                 */
                                 if($dependentesCreche){
                                        if ($anoReferencia<=2017) $auxilioCreche = $dependentesCreche * 699.00; else $auxilioCreche = $dependentesCreche * 719.62;
                                 ...
                                 */
                                  ...
                                  */
                                  ...
                                  /*
                                   * CÃ¡lculo de remuneração e margem consignÃ¡vel
                                   */
				 ...
				 * Teto em 2017: R$ 5531,31
				 * Teto em 2018: R$ 5645,80
*Teto em 2019: 5.839,45
                                 */

				 $query = "select tetovalor as teto from previdenciateto where ano<='".$anoReferencia."' ORDER BY ano DESC limit 1";
...
echo "<tr><td>Contribuição Funpresp Opcional (".($funprespOpcional*100)."%): </td><td align='right'><font color='660000'>(".formataNumeroReal($funprespOpcionalValor).")</font> </td></tr>";
                                  ...
                                  */
                                  if($planTit && $orgao == 1 && $isPlanAssiste == 1){
                                          ...
                                          $query = "select vencimento_basico as vb from vencimentos where
                                         referencia='12019' AND cargo='3' AND
                                         nivel='13' limit 1";
...
Margem consignável
				...
				//Ancorar na página
				if($anoReferencia == 2019 && $mesReferencia==1) echo '<a href="#" id="ancora"></a>';
                                ...
                                /*
                                 * Esta função verifica se Ã© o caso de fazer a progressÃ£o
                                 ...
                                 * 4) Se foi marcada no formulÃ¡rio a opção de progressÃ£o automÃ¡tica
...
Margem consignável
				...
				/*
					Colocar aqui as informações da nova previdência
				*/
if($anoReferencia == 2019){

if($previdencia == 1) $basenovoPSS = $basepss; else $basenovoPSS = $teto;
$novoPSSvalor = calculaNovaPrevidencia($basenovoPSS, $anoReferencia);
$aliquotaEfetiva = round(($novoPSSvalor/$basenovoPSS*100), 2);
        echo "<tr><td><b>Nova Previdência - Pespectiva</td></tr></b>";
	echo "<tr><td>Novo PSS (Progressivo)</td><td align='right'>".formataNumeroReal($novoPSSvalor)."</td></tr>";
	if($previdencia==1) echo "<tr><td>Nova Alíquota Efetiva</td><td align='right'>".$aliquotaEfetiva."%</td></tr>";
        else echo "<tr><td>Nova Alíquota Efetiva (sobre o teto)</td><td align='right'>".$aliquotaEfetiva."%</td></tr>";
}
                                 echo "</table><hr />";
                 }
         }
...
function calculaIRRF($vencimento, $dependentes, $ano){
    ...
    ?>
         ...
         <div>
                ...
                <p>Se você gostou, contribua com a iniciativa. Doe! </p>
                <a href='index.php'>Novo Cálculo</a>
                <hr width="50%">
        <p>Atualizado em 02/11/2017. <a href="sobre.php">Sobre o Sistema</a></p>
